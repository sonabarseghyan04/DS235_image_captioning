...
def run_full_blip2_inference():
    model_id = "Salesforce/blip2-opt-2.7b"
    input_dir = "data/flickr8k_sample/images"
    output_dir = "results"
    output_file = os.path.join(output_dir, "blip2_full_results.json")
    ...
    for file_name in tqdm(image_files, desc="BLIP-2 Inference"):
